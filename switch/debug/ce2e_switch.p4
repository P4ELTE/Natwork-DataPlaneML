...
parser EgressParserImpl(packet_in packet,
    ...
    state start {
        ...
        transition select (istd.packet_path) {
            ...
            PSA_PacketPath_t.NORMAL: accept;
        }
    }

    state copy_clone_e2e_meta {
        user_meta.test = clone_e2e_meta.test;
        transition accept;
    }
}
